...
import (
	...
	"github.com/charmbracelet/hyper/internal/backend"
	"github.com/charmbracelet/hyper/internal/config"
	_ "github.com/charmbracelet/hyper/internal/swagger"
...
func DefaultHost() string {
	...
	if err == nil && usr.Uid != "" {
		sock = fmt.Sprintf("hyper-%s.sock", usr.Uid)
	}
...
// Server represents a Hyper server bound to a specific address.
type Server struct {
