...
const docTemplate = `{
    ...
    "info": {
        ...
        "license": {
            "name": "MIT",
            "url": "https://github.com/charmbracelet/hyper/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_charmbracelet_hyper_internal_proto.Message"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "github_com_charmbracelet_hyper_internal_config.Config": {
            "type": "object",
            "properties": {
                "$schema": {
                    "type": "string"
                ...
                "options": {
                    "$ref": "#/definitions/github_com_charmbracelet_hyper_internal_config.Options"
                },
                "permissions": {
        ...
        "github_com_charmbracelet_hyper_internal_config.Options": {
            "type": "object",
            "properties": {
                "attribution": {
                ...
                "data_directory": {
                    "description": "DataDirectory is where Hyper keeps per-project state such as the SQLite database and workspace overrides. Relative paths are resolved against the working directory; absolute paths are used verbatim. After defaulting the stored value is always absolute.",
                    "type": "string"
                },
                "debug": {
                    "type": "boolean"
        ...
        "github_com_charmbracelet_hyper_internal_proto.Message": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "proto.Workspace": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_charmbracelet_hyper_internal_config.Config"
                },
                "data_dir": {
                    "type": "string"
                },
