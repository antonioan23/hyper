...
type Styles struct {
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "HYPER" gradient
		LogoGradFromColor color.Color    // "HYPER" wordmark gradient start
		LogoGradToColor   color.Color    // "HYPER" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "Hyper" wordmark gradient start
		SmallGradToColor   color.Color    // Small "Hyper" wordmark gradient end
	}
