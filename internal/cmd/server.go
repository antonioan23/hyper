...
var serverCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, _ []string) error {
		...
		logFile := filepath.Join(config.GlobalCacheDir(), "server-"+safeHostName(hostURL), "hyper.log")

		if term.IsTerminal(os.Stderr.Fd()) {
			hyperlog.Setup(logFile, debug, os.Stderr)
		} else {
		...
		slog.Info("Starting Hyper server...", "addr", serverHost)
