...
func TestHyperInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHyperInfo(cfg, nil, nil, nil, nil)
...
func TestHyperInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/hyper/hyper.json",
		"/project/.hyper/hyper.json",
	)
	output := buildHyperInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/hyper/hyper.json")
	require.Contains(t, output, "/project/.hyper/hyper.json")
}

func TestHyperInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildHyperInfo(cfg, mgr, nil, nil, nil)
...
func TestHyperInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.hyper",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.hyper")
	require.Contains(t, output, "debug = true")
}

func TestHyperInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildHyperInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildHyperInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestHyperInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "hyper.json")
	...
	output := buildHyperInfo(store, nil, nil, nil, nil)
...
func TestHyperInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "hyper-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("hyper-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHyperInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "hyper-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestHyperInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "hyper-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestHyperInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestHyperInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
